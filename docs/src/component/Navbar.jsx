...
const Navbar = () => {
  ...
  return (
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-all duration-300 transform active:scale-95 hover:scale-105 cursor-pointer"
            >
              ...
              <div className="relative w-6 h-6">
                ...
                {/* Middle line */}
                <span 
                  className={`absolute top-2.5 left-0 w-6 h-0.5 bg-current transform transition-all duration-300 ease-in-out ${
      ...
      <div className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-800 border-t border-gray-700 transform transition-transform duration-300 ease-in-out">
          {navItems.map((item, index) => (
            <button
              ...
              className={`w-full text-left px-3 py-2 rounded-lg text-base font-medium transition-all duration-300 transform hover:scale-105 active:scale-95 cursor-pointer ${
                activeTab === item.id
          ...
          {/* Mobile User Profile */}
          <div 
            className="px-3 py-3 border-t border-gray-700 mt-4 transform transition-all duration-300 ease-in-out"
            style={{
              animationDelay: `${navItems.length * 50 + 100}ms`,
              transform: isOpen ? 'translateX(0)' : 'translateX(-20px)',
              opacity: isOpen ? 1 : 0,
              transition: `all 0.3s ease-in-out ${navItems.length * 50 + 100}ms`
            }}
          >
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full flex items-center justify-center">
